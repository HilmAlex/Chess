 ...
 * @author Alex Padilla
 */
public interface IHorizontalMovement extends IMovement{
     ...
     */
    default boolean checkHorizontalMovement(PositionOnBoard initialPosition, PositionOnBoard finalPosition) {
